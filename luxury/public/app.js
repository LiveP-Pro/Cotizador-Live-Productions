...
function quoteDocumentStyles() {
  return `
    *,*::before,*::after{box-sizing:border-box}
    ...
    .poster-service-price-row{color:#f8f8f6;font-size:15px;line-height:1.2}.poster-service-price-row td{padding:0;vertical-align:middle}.poster-service-price-label{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.poster-service-price-amount{width:132px;padding-left:16px!important;color:#e2b348;font-size:18px;font-weight:900;text-align:right;white-space:nowrap}.poster-service-price-box-columns .poster-service-price-row{font-size:12px}.poster-service-price-box-columns .poster-service-price-label{padding-left:22px}.poster-service-price-box-columns .poster-service-price-list:first-child .poster-service-price-label{padding-left:0}.poster-service-price-box-columns .poster-service-price-amount{width:108px;padding-left:9px!important;font-size:16px}.poster-service-price-box-dense .poster-service-price-list{border-spacing:0 3px}.poster-service-price-box-dense .poster-service-price-row{font-size:10px;line-height:1.08}.poster-service-price-box-dense .poster-service-price-amount{width:90px;font-size:13px;line-height:1.08}
